...
<head>
    ...
    <!-- Include jQuery (necessary for Select2 to work) -->
    ...
    <div class="container-fluid">
        ...
        <div class="main_sidebar bring_right">
            <div class="main_sidebar_wrapper">
                ...
                <ul>
                    <li><span class="glyphicon glyphicon-home"></span><a href="{{ route('users.index') }}">الصفحة
                            الرئيسية</a></li>
                    ...
                    <li><span class="glyphicon glyphicon-edit"></span><a
                            href="{{ route('invoice.index') }}">الفواتير</a>
                        <ul class="drop_main_menu">
