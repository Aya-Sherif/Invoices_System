...
<div class="main_content_container">
    <div class="main_container  main_menu_open">
        ...
        <div class="page_content">
            ...
            <div class="form">
                <form class="form-horizontal" action="{{ route('productdetails.updateQuantity',$product->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input1" name="المقاس" placeholder="المقاس" value="{{ $product->size}}" disabled>
                        </div>
                    </div>
                    ...
                    <!-- Quantity Field -->
                    <div class="form-group">
                        <label for="input4" class="col-sm-2 control-label bring_right left_text">الكميه المتاحه</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="input4" name="الكميه_المتاحه" placeholder="الكميه" value="{{ $product->quantity}}" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input4" class="col-sm-2 control-label bring_right left_text">الكميه المضافه</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="input4" name="الكميه" placeholder=" الكميه الجديده"  >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 col-sm-offset-0">
                            <button type="submit" class="btn btn-danger pull-left">إضافة الكميه الجديده</button>
                        </div>
                    </div>
                </form>
            </div>
